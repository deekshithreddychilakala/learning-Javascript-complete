...
// const arr = [7, 8, 9];
// const badNewArr = [1, 2, arr[0], arr[1], arr[1]];
...
// The game has already started, so the score is 0:0 (no goals have been scored yet)
// GOOD LUCK 😀
...
// console.log(maskCreditCard(433789814530));
// console.log(maskCreditCard('433789814530433789814530'));
